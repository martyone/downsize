...
describe('still', () => {
  it('extracts a frame from an MP4 video', (t, done) => {
    diff.still({
  ...
  it('extracts a frame from a very short video', (t, done) => {
    diff.still({
  ...
  it('extracts a frame from a video that only has a single frame', (t, done) => {
    diff.still({
  ...
  it('extracts and crops a frame from an MP4 video', (t, done) => {
    diff.still({
      input: 'videos/countdown.mp4',
  ...
  it('can extract a frame at a given second', (t, done) => {
    diff.still({
  ...
  it('can extract a frame in the middle', (t, done) => {
    diff.still({
      input: 'videos/big_buck_bunny.mp4',
